...
public class ConvenienceCodecs {
    public static class ByteToBigintCodec extends MappingCodec<Long, Byte> {
        ...
        public ByteToBigintCodec() {
            super(TypeCodecs.BIGINT, GenericType.BYTE);
        }
    ...
    public static class ShortToBigintCodec extends MappingCodec<Long, Short> {
        ...
        public ShortToBigintCodec() {
            super(TypeCodecs.BIGINT, GenericType.SHORT);
        }
    ...
    public static class IntegerToBigintCodec extends MappingCodec<Long, Integer> {
        ...
        public IntegerToBigintCodec() {
            super(TypeCodecs.BIGINT, GenericType.INTEGER);
        }
    ...
    public static class FloatToDecimalCodec extends MappingCodec<BigDecimal, Float> {
        ...
        public FloatToDecimalCodec() {
            super(TypeCodecs.DECIMAL, GenericType.FLOAT);
        }
    ...
    public static class DoubleToDecimalCodec extends MappingCodec<BigDecimal, Double> {
        ...
        public DoubleToDecimalCodec() {
            super(TypeCodecs.DECIMAL, GenericType.DOUBLE);
        }
    ...
    public static class IntegerToDecimalCodec extends MappingCodec<BigDecimal, Integer> {
        ...
        public IntegerToDecimalCodec() {
            super(TypeCodecs.DECIMAL, GenericType.INTEGER);
        }
    ...
    public static class LongToDecimalCodec extends MappingCodec<BigDecimal, Long> {
        ...
        public LongToDecimalCodec() {
            super(TypeCodecs.DECIMAL, GenericType.LONG);
        }
    ...
    public static class FloatToDoubleCodec extends MappingCodec<Double, Float> {
        ...
        public FloatToDoubleCodec() {
            super(TypeCodecs.DOUBLE, GenericType.FLOAT);
        }
    ...
    public static class ByteToIntCodec extends MappingCodec<Integer, Byte> {
        ...
        public ByteToIntCodec() {
            super(TypeCodecs.INT, GenericType.BYTE);
        }
    ...
    public static class ShortToIntCodec extends MappingCodec<Integer, Short> {
        ...
        public ShortToIntCodec() {
            super(TypeCodecs.INT, GenericType.SHORT);
        }
    ...
    public static class LongToIntCodec extends MappingCodec<Integer, Long> {
        ...
        public LongToIntCodec() {
            super(TypeCodecs.INT, GenericType.LONG);
        }
    ...
    public static class StringToTinyintCodec extends MappingCodec<Byte, String> {
        ...
        public StringToTinyintCodec() {
            super(TypeCodecs.TINYINT, GenericType.STRING);
        }
    ...
    public static class StringToSmallintCodec extends MappingCodec<Short, String> {
        ...
        public StringToSmallintCodec() {
            super(TypeCodecs.SMALLINT, GenericType.STRING);
        }
    ...
    public static class StringToBigintCodec extends MappingCodec<Long, String> {
        ...
        public StringToBigintCodec() {
            super(TypeCodecs.BIGINT, GenericType.STRING);
        }
    ...
    public static class ByteToSmallintCodec extends MappingCodec<Short, Byte> {
        ...
        public ByteToSmallintCodec() {
            super(TypeCodecs.SMALLINT, GenericType.BYTE);
        }
    ...
    public static class LongToVarintCodec extends MappingCodec<BigInteger, Long> {
        ...
        public LongToVarintCodec() {
            super(TypeCodecs.VARINT, GenericType.LONG);
        }
    ...
    public static class StringToTimestampCodec extends MappingCodec<Instant, String> {
        ...
        public StringToTimestampCodec() {
            super(TypeCodecs.TIMESTAMP, GenericType.STRING);
        }
    ...
    public static class LongToTimestampCodec extends MappingCodec<Instant, Long> {

        public static final LongToTimestampCodec INSTANCE = new LongToTimestampCodec();

        public LongToTimestampCodec() {
            super(TypeCodecs.TIMESTAMP, GenericType.LONG);
        }

        @Nullable
        @Override
        protected Long innerToOuter(@Nullable Instant value) {
            return value == null ? null : value.toEpochMilli();
        }

        @Nullable
        @Override
        protected Instant outerToInner(@Nullable Long value) {
